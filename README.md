...
You can either add copy paste these functions and aliases to your '.bashrc' or create a new file e.g. '.kube_aliases' and add this line to your '.bashrc' ```bash source kube_aliases```. After you save the file, you can type ```bash source .bashrc``` to your terminal to use them on the spot.
